...
char      sArxSor[80];
char      sArxEnt[80];
char      *lpRutSortida = "\\MANGOTX\\";
char      *lpRutEntrada = "\\MANGORX\\";
char      *lpNomArx = "PDV.";
char      *lpTerm;
SINT      iNumBytes = 0;
SINT      iCicle = 0;
...
void main()
{
   ...
   {
//      if ( iOpe == 243 ) // consulta cheques bankinform
//      {
//         if ( iContestacio == 3 )
//            iContestacio = 0;
//      }
      ...
      {
      //probar esto para error 01. debe resolver porque queda pendiente
         if ( iContestacio != 1 )
         {
         remove(sFicWrk);
         remove(sFic123);
